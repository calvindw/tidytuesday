...
#get the data
df <- read.csv2("https://raw.githubusercontent.com/calvindw/tidytuesday/master/clean_data/UNWTO_1995_2018_departures.csv")
...
#pop_data <- read.csv2("https://raw.githubusercontent.com/calvindw/datasets/master/temp/SP.POP.TOTL_1995_2018.csv")
